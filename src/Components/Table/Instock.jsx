  ...
  return (
    <tr>
      <td>
        <button
          type="button"
          className="delete-wishlistBtn btn"
          id="delete_wishlistBtn"
        >
      ...
      <td>
        <h3 className="wishlist-product-name">Structure material</h3>
      </td>
      <td>
      ...
      <td>
        <span className="wishlist-status-tag wishlist-in-stock">In Stock</span>
      </td>
      <td>
        <div className="wishlist-addcartbtn">
          <button
            type="button"
            className="btn wishlist-addcartBtn"
            id="wishlist_addcartBtn"
          >
            Add to Cart
          </button>
        </div>
